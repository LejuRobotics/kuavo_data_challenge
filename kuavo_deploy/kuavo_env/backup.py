...
def depth_preprocess(depth, depth_range=[0,1000]):
...
class KuavoBaseRosEnv(gym.Env):
    ...
    def cam_h_callback(self, msg):
        self.head_cam_h_img = img_preprocess(self.process_rgb_img(msg))

    def cam_l_callback(self, msg):
        self.wrist_cam_l_img = img_preprocess(self.process_rgb_img(msg))
    
    def cam_r_callback(self, msg):
        self.wrist_cam_r_img = img_preprocess(self.process_rgb_img(msg))
    ...
    def cam_h_depth_callback(self, msg):
        self.depth_h_img = depth_preprocess(self.process_depth_img(msg), depth_range=self.depth_range)

    def cam_l_depth_callback(self, msg):
        self.depth_l_img = depth_preprocess(self.process_depth_img(msg), depth_range=self.depth_range)

    def cam_r_depth_callback(self, msg):
        self.depth_r_img = depth_preprocess(self.process_depth_img(msg), depth_range=self.depth_range)
