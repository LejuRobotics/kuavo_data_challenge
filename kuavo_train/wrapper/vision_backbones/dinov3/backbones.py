...
def _make_dinov3_vit(
    ...
    **kwargs,
    ...
    from kuavo_train.wrapper.vision_backbones.dinov3.vision_transformer import DinoVisionTransformer
...
def _make_dinov3_convnext(
    ...
    **kwargs,
    ...
    from kuavo_train.wrapper.vision_backbones.dinov3.convnext import ConvNeXt
...
def dinov3_convnext_tiny(
    ...
    **kwargs,
    ...
    from kuavo_train.wrapper.vision_backbones.dinov3.convnext import convnext_sizes
